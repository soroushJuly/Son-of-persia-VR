...
public class AutoSpawnObjectInHandOnGrab2 : MonoBehaviour
{
    ...
    public void TrySpawn()
    {
        ...
        currentHand.xrDirectInteractor.interactionManager.SelectEnter(currentHand.xrDirectInteractor, spawnedObject);
    }
